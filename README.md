...
|-----------------|------------|-------------------------------------------------------------------------------|
| **AUC**         | 0.994      | Capacidad discriminatoria casi perfecta del modelo.                           |
| **Sensibilidad (Recall)** | 96.63%    | Alta capacidad para detectar pacientes enfermos (minimiza falsos negativos).  |
...
|-----------------|-------------------------------------------------------------|----------------------------------------------------------|
| **Dataset Principal** | [UCI Machine Learning Repository: Heart Disease Data Set](https://archive.ics.uci.edu/ml/datasets/heart+disease) | Fuente de los 14 atributos clínicos (Cleveland) usados para el entrenamiento y validación del modelo. |
...
> Nota: Este proyecto es solo con fines educativos y no debe utilizarse como herramienta diagnóstica real.
